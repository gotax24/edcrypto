  ...
  return (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="relative">
        ...
        <div className="w-24 h-24 border-8 border-gray-700 rounded-full border-t-blue-500 animate-spin"></div>
        ...
        <div className="absolute w-8 h-8 rounded-full top-8 left-8 bg-gradient-to-br from-blue-500 via-blue-400 to-blue-600 animate-pulse"></div>
      </div>
    </div>
  );
};
